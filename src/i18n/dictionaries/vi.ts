const vi = {
  ...
  'kudos.compose.title': 'Gửi lời cám ơn và ghi nhận đến đồng đội',
  'kudos.compose.receiver.label': 'Người nhận',
  'kudos.compose.receiver.placeholder': 'Tìm kiếm',
  'kudos.compose.danhHieu.label': 'Danh hiệu',
  'kudos.compose.danhHieu.placeholder': 'Dành tặng một danh hiệu cho đồng đội',
  'kudos.compose.danhHieu.helper1': 'Ví dụ: Người truyền động lực cho tôi.',
  'kudos.compose.danhHieu.helper2': 'Danh hiệu sẽ hiển thị làm tiêu đề Kudos của bạn.',
  'kudos.compose.content.placeholder': 'Hãy gửi gắm lời cám ơn và ghi nhận đến đồng đội tại đây nhé!',
  'kudos.compose.content.helper': 'Bạn có thể \'@ + tên\' để nhắc tới đồng nghiệp khác',
  'kudos.compose.hashtag.label': 'Hashtag',
  'kudos.compose.hashtag.note': 'Tối đa 5',
  'kudos.compose.image.label': 'Image',
  'kudos.compose.image.note': 'Tối đa 5',
  'kudos.compose.anonymous.label': 'Gửi lời cám ơn và ghi nhận ẩn danh',
  'kudos.compose.communityLink': 'Tiêu chuẩn cộng đồng',
  'kudos.compose.cancel': 'Hủy',
  'kudos.compose.submit': 'Gửi',
  'kudos.compose.success': 'Đã gửi Kudo! 🎉',
  'kudos.compose.err.receiverRequired': 'Vui lòng chọn người nhận',
  'kudos.compose.err.receiverIsSelf': 'Bạn không thể gửi Kudo cho chính mình',
  'kudos.compose.err.receiverNotFound': 'Không tìm thấy người nhận này',
  'kudos.compose.err.danhHieuRequired': 'Vui lòng nhập danh hiệu',
  'kudos.compose.err.danhHieuTooLong': 'Danh hiệu tối đa 60 ký tự',
  'kudos.compose.err.contentTooShort': 'Lời cám ơn phải có ít nhất 5 ký tự',
  'kudos.compose.err.contentTooLong': 'Lời cám ơn tối đa 2000 ký tự',
  'kudos.compose.err.hashtagRequired': 'Vui lòng chọn ít nhất 1 hashtag',
  'kudos.compose.err.hashtagTooMany': 'Tối đa 5 hashtag',
  'kudos.compose.err.imageTooLarge': 'Ảnh quá lớn (tối đa 5 MB)',
  'kudos.compose.err.imageInvalidMime': 'Chỉ chấp nhận ảnh JPEG, PNG hoặc WebP',
  'kudos.compose.err.imageTooMany': 'Tối đa 5 ảnh',
  'kudos.compose.err.rateLimited': 'Bạn gửi Kudo quá nhanh, vui lòng thử lại sau',
  'kudos.compose.err.duplicate': 'Bạn vừa gửi kudo y hệt — đã bị chặn trùng lặp',
  'kudos.compose.err.network': 'Không gửi được Kudo, vui lòng thử lại',
  'kudos.compose.dirty.title': 'Bỏ bản nháp này?',
  'kudos.compose.dirty.body': 'Nội dung chưa gửi sẽ bị mất.',
  'kudos.compose.dirty.discard': 'Bỏ',
  'kudos.compose.dirty.continue': 'Tiếp tục viết',
} as const;
