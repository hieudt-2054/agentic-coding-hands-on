...
-- Kudos (12) — includes danh_hieu + content_html back-filled
INSERT INTO public.kudos (id, sender_id, receiver_id, content, content_html, danh_hieu, is_anonymous, department_id, hearts_count, created_at) VALUES
  ('44444444-4444-4444-4444-444444444401', '33333333-3333-3333-3333-333333333301', '33333333-3333-3333-3333-333333333302', 'Cảm ơn anh Chức đã chia sẻ kinh nghiệm leader nhiệt tình trong retro tuần này — cả team học được rất nhiều.', 'Cảm ơn anh Chức đã chia sẻ kinh nghiệm leader nhiệt tình trong retro tuần này — cả team học được rất nhiều.', 'Người truyền cảm hứng', false, '11111111-1111-1111-1111-111111111102', 1000, now() - interval '2 hours'),
  ('44444444-4444-4444-4444-444444444402', '33333333-3333-3333-3333-333333333303', '33333333-3333-3333-3333-333333333302', 'Cảm ơn anh đã kéo cả PRs của tôi trong tuần sát deadline — đúng nghĩa Super Hero.', 'Cảm ơn anh đã kéo cả PRs của tôi trong tuần sát deadline — đúng nghĩa Super Hero.', 'Người cứu vớt deadline', false, '11111111-1111-1111-1111-111111111102', 820, now() - interval '6 hours'),
  ('44444444-4444-4444-4444-444444444403', '33333333-3333-3333-3333-333333333304', '33333333-3333-3333-3333-333333333305', 'Cảm ơn chị An đã review code siêu kỹ, em học hỏi được nhiều!', 'Cảm ơn chị An đã review code siêu kỹ, em học hỏi được nhiều!', 'Người mentor xuất sắc', false, '11111111-1111-1111-1111-111111111103', 450, now() - interval '10 hours'),
  ('44444444-4444-4444-4444-444444444404', '33333333-3333-3333-3333-333333333306', '33333333-3333-3333-3333-333333333301', 'Cảm ơn Xuân đã support demo session — nhờ có bạn mà khách hàng thấy được giá trị team.', 'Cảm ơn Xuân đã support demo session — nhờ có bạn mà khách hàng thấy được giá trị team.', 'Ngôi sao demo', false, '11111111-1111-1111-1111-111111111105', 310, now() - interval '14 hours'),
  ('44444444-4444-4444-4444-444444444405', '33333333-3333-3333-3333-333333333302', '33333333-3333-3333-3333-333333333303', 'Cảm ơn em đã chủ động viết documentation, future-you cảm ơn em rất nhiều.', 'Cảm ơn em đã chủ động viết documentation, future-you cảm ơn em rất nhiều.', 'Người giữ tri thức team', false, '11111111-1111-1111-1111-111111111101', 280, now() - interval '1 day'),
  ('44444444-4444-4444-4444-444444444406', '33333333-3333-3333-3333-333333333305', '33333333-3333-3333-3333-333333333304', 'Cảm ơn An đã tổ chức buổi knowledge sharing tuần trước — thông tin rất thiết thực.', 'Cảm ơn An đã tổ chức buổi knowledge sharing tuần trước — thông tin rất thiết thực.', 'Người lan tỏa kiến thức', false, '11111111-1111-1111-1111-111111111104', 200, now() - interval '1 day 4 hours'),
  ('44444444-4444-4444-4444-444444444407', '33333333-3333-3333-3333-333333333301', '33333333-3333-3333-3333-333333333306', 'Cảm ơn bạn đã giúp fix production incident đêm qua.', 'Cảm ơn bạn đã giúp fix production incident đêm qua.', 'Người anh hùng đêm khuya', false, '11111111-1111-1111-1111-111111111105', 180, now() - interval '1 day 12 hours'),
  ('44444444-4444-4444-4444-444444444408', '33333333-3333-3333-3333-333333333302', '33333333-3333-3333-3333-333333333305', 'Cảm ơn Thúy luôn nhiệt tình đón tiếp intern mới.', 'Cảm ơn Thúy luôn nhiệt tình đón tiếp intern mới.', 'Người mẹ của intern', false, '11111111-1111-1111-1111-111111111103', 150, now() - interval '2 days'),
  ('44444444-4444-4444-4444-444444444409', '33333333-3333-3333-3333-333333333303', '33333333-3333-3333-3333-333333333301', 'Ngày nào cũng commit sớm nhất team — cảm ơn Xuân!', 'Ngày nào cũng commit sớm nhất team — cảm ơn Xuân!', 'Người commit sớm nhất', false, '11111111-1111-1111-1111-111111111102', 120, now() - interval '2 days 6 hours'),
  ('44444444-4444-4444-4444-444444444410', '33333333-3333-3333-3333-333333333304', '33333333-3333-3333-3333-333333333302', 'Cảm ơn anh đã là mentor tận tâm trong suốt quý vừa qua.', 'Cảm ơn anh đã là mentor tận tâm trong suốt quý vừa qua.', 'Người mentor của quý', false, '11111111-1111-1111-1111-111111111102', 95, now() - interval '3 days'),
  ('44444444-4444-4444-4444-444444444411', '33333333-3333-3333-3333-333333333306', '33333333-3333-3333-3333-333333333304', 'Cảm ơn An đã giúp debug vụ API rate limiting trong tuần.', 'Cảm ơn An đã giúp debug vụ API rate limiting trong tuần.', 'Người giải quyết vấn đề', false, '11111111-1111-1111-1111-111111111104', 70, now() - interval '3 days 8 hours'),
  ('44444444-4444-4444-4444-444444444412', '33333333-3333-3333-3333-333333333305', '33333333-3333-3333-3333-333333333306', 'Cảm ơn Linh đã chia sẻ deck về Realtime architecture, mình nâng cấp được ngay.', 'Cảm ơn Linh đã chia sẻ deck về Realtime architecture, mình nâng cấp được ngay.', 'Kiến trúc sư Realtime', false, '11111111-1111-1111-1111-111111111105', 45, now() - interval '4 days')
ON CONFLICT DO NOTHING;
